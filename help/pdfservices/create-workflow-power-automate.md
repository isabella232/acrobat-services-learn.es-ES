...
Aprende a crear tu primer flujo en [Microsoft Power Automate](https://flow.microsoft.com) uso del [Servicios de Adobe PDF](https://us.flow.microsoft.com/es-es/connectors/shared_adobepdftools/adobe-pdf-services/) conector.
...
1. Bajo *Elija cómo activar este flujo*, seleccione **[!UICONTROL Activación manual de un flujo]**.
...
1. Buscar por *Convertir Word en PDF* en la barra de búsqueda.
...
1. Uso del **[!UICONTROL Contenido dinámico]** panel, seleccionar **[!UICONTROL Contenido del archivo]**.
...
1. Seleccionar **[!UICONTROL Manualmente]** y luego **[!UICONTROL Guardar y probar]**.
...
La siguiente parte se basa en la parte 1 y utiliza la *Generar documento desde Word* para combinar dinámicamente datos en el documento.
...
1. Al editar el flujo, seleccione **[!UICONTROL Activación manual de un flujo]** para expandir la acción.
1. Seleccionar **[!UICONTROL Agregar una entrada]**.
1. Seleccionar **[!UICONTROL Texto]**.
1. Asigne un nombre al campo *Nombre*.
...
![Acción Obtener contenido de archivo de OneDrive en Microsoft Power Automate](assets/getFileContentAction02.png)
...
1. Buscar por *Servicios de Adobe PDF* en la barra de búsqueda.
1. Seleccionar **[!UICONTROL Servicios de Adobe PDF]**.
1. Seleccione la **[!UICONTROL Generar documento a partir de una plantilla de Word]** acción .
1. En la **[!UICONTROL Nombre de archivo de plantilla]** , asigne al archivo el nombre que desee, pero debe terminar con *.docx*.

#### Combinar datos

Uso del *Generar documento a partir de una plantilla de Word* , puede combinar en su documento datos de cualquiera de las diferentes variables que se encontraban anteriormente en el flujo mediante contenido dinámico.
...
1. Coloque el cursor en el campo entre las dos comillas del *FirstName* valor.
1. Uso del **[!UICONTROL Contenido dinámico]** , inserte el *Nombre* del activador Manual de una acción de flujo.

   ![Generar documento con etiquetas de datos en JSON](assets/generateDocumentJSONAction.png)

1. Repita los pasos 7-8 para el **[!UICONTROL LastName]** y **[!UICONTROL Salario]** campos.
...
>[!TIP]
>
>La *Generar documento a partir de una plantilla de Word* Esta acción utiliza la API de generación de documentos de Adobe. Si desea obtener más información sobre cómo crear plantillas, aquí tiene algunos recursos:
>
...
>* [Documentación de Adobe Document Generation API](https://developer.adobe.com/document-services/docs/overview/document-generation-api/)
...
![Pantalla Ejecutar flujo en Microsoft Power Automate que solicita entradas](assets/runFlowParameters.png)
...
1. En la **[!UICONTROL Contenido del archivo -1]** , utilice el campo **[!UICONTROL Contenido dinámico]** para insertar el *Contenido de archivo de PDF* valor de la **[!UICONTROL Convertir Word en PDF]** paso.
1. Para añadir el siguiente documento, seleccione **+ [!UICONTROL agregar nuevo elemento]**.
1. En la **[!UICONTROL Contenido del archivo - 2]** , utilice el campo **[!UICONTROL Contenido dinámico]** para insertar el **[!UICONTROL Contenido del archivo de salida]** valor de la *Generar documento a partir de una plantilla de Word* paso.
